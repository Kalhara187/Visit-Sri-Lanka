...
export default function ContactPage() {
  ...
  const contactInfo = {
    address: "123 Tourism Lane, Colombo 01, Sri Lanka",
    phone: "+94 11 234 5678",
    email: "info@visitsrilanka.com",
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-sri-lanka-teal focus:border-transparent outline-none transition ${errors.name ? "border-red-500" : "border-gray-300"}`}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-sri-lanka-teal focus:border-transparent outline-none transition ${errors.subject ? "border-red-500" : "border-gray-300"}`}
                    >
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-sri-lanka-teal/10 rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-6 h-6 text-sri-lanka-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600 mt-1 whitespace-pre-line">{contactInfo.hours}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social) => (
                    <a
                      key={social.name}
                      href={social.href}
                      className="w-12 h-12 bg-sri-lanka-teal/10 rounded-full flex items-center justify-center text-sri-lanka-teal hover:bg-sri-lanka-teal hover:text-white transition-colors"
